...
import de.fau.cs.mad.fablab.android.productMap.Paintings;
...
public class DrawingFragment extends View
{
    ...
    public DrawingFragment(Context context, FablabView fablabView, double positionX, double positionY, String locationName)
    {
        super(context);
